...
def main():
    ...
    # print(f"Total conversations: {len(conversation_data)}")
    # print(f"Unique Selected_Agent_Column values: {len(selected_agent_column_data)}")
    
    # # Show unique Selected_Agent_Column values
    # print(f"Selected_Agent_Column values: {list(selected_agent_column_data.keys())}")
